...
import './SidebarForgotPass.css';

const SidebarForgotPass = () => {
    ...
    <div className="sidebar-container">
      <Navbar bg="light" expand="lg" className="navbar">
        <Navbar.Brand onClick={toggleSidebar}>
          <FaBars className='hamburger-password' />
        </Navbar.Brand>
      </Navbar>
      <div className={`sidebar ${isOpen ? 'open' : ''}`}>
        <div className="profile-section">
          <img src={profilePicture} alt="Profile" className="profile-pic-password" />
          <h2 className="profile-name-password">Username</h2>
          <p className="invitation-code-password">Invitation code: BA7XLA</p>
          ...
          <div className="balance-info-usdt">
            ...
            <p className='tax-usdt'>USDT {tax.toFixed(2)}s</p>
          </div>
...
export default SidebarForgotPass;
