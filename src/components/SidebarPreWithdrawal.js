...
import './SidebarPreWithdrawal.css';

const SidebarPreWithdrawal = () => {
    ...
    <div className="sidebar-container">
      <Navbar bg="light" expand="lg" className="navbar">
        <Navbar.Brand onClick={toggleSidebar}>
          <FaBars className='hamburger-pre' />
        </Navbar.Brand>
      </Navbar>
      <div className={`sidebar-pre ${isOpen ? 'open' : ''}`}>
        <div className="profile-section">
          <img src={profilePicture} alt="Profile" className="profile-pic-pre" />
          <h2 className="profile-name-pre">Username</h2>
          <p className="invitation-code-pre">Invitation code: BA7XLA</p>
...
export default SidebarPreWithdrawal;
