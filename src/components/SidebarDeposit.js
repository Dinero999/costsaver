...
import './SidebarDeposit.css';

const SidebarDeposit = () => {
    ...
    <div className="sidebar-container">
      <Navbar bg="light" expand="lg" className="navbar">
        <Navbar.Brand onClick={toggleSidebar}>
          <FaBars className='hamburger-deposit' />
        </Navbar.Brand>
      </Navbar>
      <div className={`sidebar ${isOpen ? 'open' : ''}`}>
        <div className="profile-section">
          <img src={profilePicture} alt="Profile" className="profile-pic-deposit" />
          <h2 className="profile-name-deposit">Username</h2>
          <p className="invitation-code-deposit">Invitation code: BA7XLA</p>
