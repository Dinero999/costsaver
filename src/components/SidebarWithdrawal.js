...
import './SidebarWithdrawal.css';

const SidebarWithdrawal = () => {
    ...
    <div className="sidebar-container">
      <Navbar bg="light" expand="lg" className="navbar">
        <Navbar.Brand onClick={toggleSidebar}>
          <FaBars className='hamburger-withdrawal' />
        </Navbar.Brand>
      </Navbar>
      <div className={`sidebar ${isOpen ? 'open' : ''}`}>
        <div className="profile-section">
          <img src={profilePicture} alt="Profile" className="profile-pic-withdrawal" />
          <h2 className="profile-name-withdrawal">Username</h2>
          <p className="invitation-code-withdrawal">Invitation code: BA7XLA</p>
